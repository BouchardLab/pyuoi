...
def train_Poisson_model(model, device, train_loader, val_loader, n_epochs, lr, L1_alpha=0.0, use_scheduler=False, firing_rates=None, train_sampler=None, val_every=10, print_every=2):
