#!/usr/bin/env python3
"""
python gen_dale_poissonV5.py --num_neurons 10 --num_excite 6 --num_steps 1000 --dataName test_dale
...
from UtilDalePoissonV5 import estimate_rates, geom_edges_mask, true_edges_mask
...
def main():
    ...
    spikeD = {
            ...
            'coincidence_rates': rates_dict['coincidence_rates'],
        }
