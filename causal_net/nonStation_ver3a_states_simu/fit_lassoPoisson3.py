...
def main():
    ...
    losses_total, losses_wo_L1, learning_rates, train_epochs, sparsity_epoch, nz_offdiag_epoch, spectral_radius_epoch = train_Poisson_model(
        ...
        train_sampler=None, apply_prox=(args.L1_alpha > 0), minW=args.minW, rho_max=args.rho_max, prescale_m_step_4_ArhoMax=args.prescale_m_step_4_ArhoMax, L1_prune_epoch=args.L1_prune_epoch
    )
    ...
    lassoMD = {'batch_size': args.batch_size, 'num_samples_used': n_pairs, 'num_epochs': args.num_epochs, 'num_train_samples': n_pairs, 'learning_rate': args.lr, 'L1_alpha': args.L1_alpha, 'rho_max': args.rho_max, 'prescale_m_step_4_ArhoMax': args.prescale_m_step_4_ArhoMax, 'L1_prune_epoch': args.L1_prune_epoch, 'minW': args.minW, 'step_size': step_size, 'training_time_sec': total_time, 'num_neurons': Nn, 'dropDataFrac': args.dropDataFrac }
