...
Uses firing-rate-weighted Poisson NLL in both steps, L1 off-diagonal
...
# ═══════════════════════════════════════════════════════════════════════
#  E-step: simplex PGD  (from prism_Estep_train.py, with neuron weights)
# ═══════════════════════════════════════════════════════════════════════
...
def run_estep(Y_prev, Y_curr, A, B, c_hat, weights,
