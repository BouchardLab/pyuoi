...
def main():
    ...
    parser.add_argument("--L1_alpha", type=float, default=0.05, help="L1 regularization strength, higher=more sparse (0: disable soft-thresholding)")
    ...
    parser.add_argument("--delay_epoch", type=int, default=120, help="Delay edge-pruning only; spectral-radius correction starts immediately")
    ...
    losses_total, losses_wo_L1, learning_rates, train_epochs, sparsity_epoch, nz_offdiag_epoch, spectral_radius_epoch = train_Poisson_model(
        ...
        train_sampler=None, apply_prox=(args.L1_alpha > 0), minW=args.minW, rho_max=args.rho_max, rho_enforce_every_batch=args.rho_enforce_every_batch, delay_epoch=args.delay_epoch
    )
