...
\title{Metrics for Accuracy of Reconstructed Connectivity Graph by PRISM-FDR Fits\\for Synthetic data}
...
\begin{abstract}
\texttt{edgeMeterAccuracy3c.py} evaluates final aggregate PRISM-FDR connectivity
...
\end{cases}
\]
The default tolerance is \(\varepsilon\) is the minimal edge weights from bagging algorithm. This keeps the test
