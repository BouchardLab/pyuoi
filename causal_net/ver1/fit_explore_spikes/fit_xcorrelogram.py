...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/global/homes/b/balewski/prjs/bioDataVault2025/causalNet_tmp2/input_fitter/',
                        help="Path to the data directory.")
    parser.add_argument('--file_name', type=str, default='daleM40-a03d69a-a8a35f7.spike.h5',
