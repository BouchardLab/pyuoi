...
def main():
    ...
    fit1FF = os.path.join(args.dataPath, f"{args.dataName}.edgeMask.npz")
    ...
    losses_total, _, learning_rates, losses_epochs = train_Poisson_model(
        model, device, train_loader, args.n_epochs, lr=args.lr, L1_alpha=0.0, use_scheduler=True, firing_rates=dataRates,
    ...
    if rank==0:
        ...
        metaD = { 'regressFit_output_name': args.fitName, 'regressFit_input_name': args.dataName,
                  ...
                  'batch_size': args.batch_size, 'num_samples_used': n_pairs, 'n_epochs': args.n_epochs, 'num_train_samples': n_pairs, 'learning_rate': args.lr, 'step_size': step_size, 'training_time_sec': total_time, 'num_neurons': M, 'desync_time': args.desync_time }
        ...
        print('\n  ./eval_fitRegress.py  --dataName %s -p a ' % (args.fitName))
