#!/bin/bash
#
# bigLassoBoots.sh -  bootstrap wrapper for distributed Lasso Poisson training
#
...
echo "Finished at: $(date)"
echo " ./selectEdges_FDR.py  --basePath \$basePath  --dataName  ${DATANAME}${BOOTS_TAG}   --num_bootstraps  $NUM_BOOTSTRAPS --alphaFDR 1e-3 -p ab  "
echo "################################################################"
