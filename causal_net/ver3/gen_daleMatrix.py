...
def commandline_parser():
    ...
    parser.add_argument("-p","--prob_synaptic_conn", type=float, default=0.15, help="Synaptic connection probability.")
    parser.add_argument("-g","--gamma_inhib", type=float, default=2., help="Inhibitory scaling factor (gamma).")
    parser.add_argument("-R", "--activity_scale", type=float, default=1., help="scaling of network activity")
